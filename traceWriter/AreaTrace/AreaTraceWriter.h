#ifndef __AREATRACEWRITER_H__
#define __AREATRACEWRITER_H__
...
class AreaTraceWriter : public GenericTraceWriter
{
  public:
    AreaTraceWriter( );
    ~AreaTraceWriter( );
  ...
  private:
    ...
    std::string traceStatisticsFile;
    std::ofstream statisticsTrace;
